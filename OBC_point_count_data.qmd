---
title: "Point Count Data Compile"
format: pdf
editor: visual
...
First, I'll visualise those locations that were surveyed in 2008.
```{r}
point_counts_08 <- all_data[["route_point"]] %>% 
  filter(route_id %in% surveys_08$route_id)
